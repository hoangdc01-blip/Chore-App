  ...
  if (viewMode === 'day') {
    ...
    return (
      <div className="flex items-center gap-2 px-4 py-3">
        <button onClick={onPrev} className="rounded-md p-1.5 hover:bg-muted transition-colors shrink-0">
          <ChevronLeft size={20} />
        </button>
        ...
        <button onClick={onNext} className="rounded-md p-1.5 hover:bg-muted transition-colors shrink-0">
